...
|---------|------|-----:|--------|
| Regression | `Dataset/regression/codeforces_rating_regression.csv` | 10,886 | `rating` (800–3500) |
| Classification | `Dataset/classification/codeforces_tag_classification.csv` | 11,011 | `tags_norm` (38 labels) |
| Master (all features) | `Dataset/original/codeforces_master_dataset.csv` | 11,156 | both |
